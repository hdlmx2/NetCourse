		...
		<div class="course_introduce_title_body">
			<div class="course_introdece_body">
				...
				<div class="course_name">
					<font>${course.teacher.institute.instituteName }</font>
				</div>
				...
				<div class="course_article">
					<div class="article">
						<a
							...
							target="_blank"><span
							style="font-size: 20px; font-weight: 800; color: #005a9e">${course.courseName }</span>
						</a>
						<s:set name="isAdd" value="#request.isadd" />
						<s:if test="#isAdd==0">
							<a href="addCourse?course=${course.courseId}" target="_blank"><div
									class="add">
									<p>添加收藏</p>
								</div></a>
						</s:if>
						<s:elseif test="#isAdd==1">
			...
			<div class="course_img">
				<div class="course_img_body">
					<img src="${course.image}" alt="" width="260px" height="150px">
				</div>
			</div>
		</div>
		...
		<div class="course_body_body">
			<div class="course_body_title">
				...
				<div class="couse_introduce_body_body">
					<font>${course.courseIntroduce }</font>
				</div>
			</div>
