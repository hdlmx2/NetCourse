...
<head>
<meta charset="UTF-8">
<title>修改${thisCourse.courseName }</title>
...
<body>
			...
			<div class="course_introduce_title_body">
				<div class="course_introdece_body">
					...
					<div class="course_article">
						<div class="article">
							<span style="font-size: 20px; font-weight: 800; color: #005a9e">${thisCourse.courseName }</span>
							<input type="submit" class="add" value="保存">

							<%-- <font>${thisCourse.courseTitle }</font> --%>

							<textarea rows="8" cols="100" name="courseTitle"
								style="margin-top: 10px" placeholder="课程标题">${thisCourse.courseTitle }</textarea>
			...
			<div class="course_body_body">
				<div class="course_body_title">
					<div class="couse_title_body">
						<font>课程介绍</font>
						<!-- 					<input type="text" style="width: 100%;height: 250px">
 -->
 ...
 --%>
						<textarea rows="16" cols="133" name="courseIntroduce">${thisCourse.courseIntroduce }</textarea>
