	...
	<div class="majorbody">
		<div class="majorCenter">
			...
			<div class="grade_body grade_border">
				<div class="course_body">
					<ul>
						<li class="course_list"><a href="">C语言程序设计</a></li>
						<li class="course_list"><a href="">Java语言程序设计</a></li>
						<li class="course_list"><a href="">高等数学</a></li>
						<li class="course_list"><a href="">计算机专业导论</a></li>
						<li class="course_list"><a href="">Python程序设计</a></li>
						<li class="course_list"><a href="">C语言程序设计</a></li>
						<li class="course_list"><a href="">Java语言程序设计</a></li>
						<li class="course_list"><a href="">高等数学</a></li>
						<li class="course_list"><a href="">计算机专业导论</a></li>
