...
页面的div结构为：
 ...
 %>
	...
	<div class="register-login">
		<ul>
			<form action="login" method="post">
				<li class="li_loggin">
					<div>
						<a class="theme-login" href="javascript:;"><font color="white">登录</font></a>
					</div>
				</li>
	...
	<div class="user_image_body">
		<a href=""><img src="image/20_big.jpg" width="50px" height="50px"></a>
		...
		<div class="navbox">
			<div class="navbox-tiles">
				<div class="person_username_title">
					...
					<div class="person_major">计算机科学与技术</div>
